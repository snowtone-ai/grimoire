/**
 * Ported from v1 (main branch) src/lib/api/gemini-prompts.ts — see D-013.
 * Server-only prompt builders used by src/app/api/gemini/generate/route.ts.
 * Prompt wording is AI behaviour, not module boundary, so it is carried over
 * unchanged.
 */
