/* Ported from v1 (main branch) src/lib/domain/reminders.ts — see D-013.
 * Deadline reminders — pure scheduling logic (v1 D-036). No dependency on
 * v1's DB or v2's domain: takes and returns only primitives and the small
 * ReminderTask/Reminder shapes defined below, so nothing about this module
 * changed in the port beyond its location.
 *
